...
ET.SubElement(application_area, "BODID").text = "infor-nid:" + tenant + ":" + company + ":" + data["Products"][0]["Product"] + "?ItemMaster&verb=Process"
...
ET.SubElement(bor_header, "Description", {"type": "Item"}).text = data["Products"][0]["Description"]
classification = ET.SubElement(bor_header, "Classification")
codes = ET.SubElement(classification, "Codes")
ET.SubElement(codes, "Code", {
    "listID": "Item Types",
    "sequence": "1"}).text = data["Products"][0]["Item_Type"]
ET.SubElement(codes, "Code", {
    "listID": "Item Groups",
    "sequence": "2", "accountingEntity": company}).text = data["Products"][0]["Item_Group"]
...
ET.SubElement(timeperiod, "EndDateTime").text = iso_8601_format_38
ET.SubElement(status, "Code", {
    "listID": "Item Status",
    "sequence": "0"} ).text = "Open"
ET.SubElement(status, "ArchiveIndicator").text ="false"
ET.SubElement(bor_header, "BaseUOMCode").text = data["Products"][0]["Unit"].upper()
